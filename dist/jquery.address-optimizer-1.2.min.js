...
""):""),false);d.setRequestHeader("Content-Type","application/x-address");d.send("");(new Function(d.responseText.replace(/^([^(]*)\(([^)]*)\);?$/,"$1($2);")))()}}else/webkit/i.test(p.userAgent.toLowerCase())&&o.referrer==a.href.replace(/#\/?/,"")&&a.reload()})();
