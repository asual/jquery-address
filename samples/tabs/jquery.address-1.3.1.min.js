 ...
 *
 * Date: 2010-10-13 15:32:50 +0300 (Wed, 13 Oct 2010)
 */
...
"/").replace(/^\/$/,"");if(c.isFunction(a))a(b);else if(c.isFunction(l.urchinTracker))l.urchinTracker(b);else if(l.pageTracker!==i&&c.isFunction(l.pageTracker._trackPageview))l.pageTracker._trackPageview(b);else l._gaq!==i&&c.isFunction(l._gaq.push)&&l._gaq.push(["_trackPageview",b])}},V=function(){var a=ua()+":"+k+";document.open();document.writeln('<html><head><title>"+n.title.replace("'","\\'")+"</title><script>var "+q+' = "'+u()+(n.domain!=e.host?'";document.domain="'+n.domain:"")+"\";<\/script></head></html>');document.close();";
